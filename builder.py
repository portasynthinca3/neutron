...
for path in c_files:
	...
	os.system('x86_64-w64-mingw32-gcc -ffreestanding -m64 -msse2 -Ignu-efi/inc -Ignu-efi/lib -Ignu-efi/inc/x86_64 -Ignu-efi/inc/protocol -nostdlib -c -o ' + path_obj + ' ' + path)
