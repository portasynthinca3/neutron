...
for path in c_files:
	...
	execute('x86_64-w64-mingw32-gcc -g2 -fno-pie -Wall -ffreestanding -mcmodel=large -mno-red-zone -m64 ' + ('-Og' if '-d' in sys.argv else '-Os') +
...
execute('mformat -i build/neutron.img -T ' + str(image_size_sectors))
